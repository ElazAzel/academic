        ...
        <DialogContent>
          ...
          <form action={handleSubmit} className="space-y-4">
            <div>
              ...
              <select name="userId" required className="mt-1 w-full rounded-xl border bg-background px-3 py-2 text-sm">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <select name="type" required className="mt-1 w-full rounded-xl border bg-background px-3 py-2 text-sm">
              ...
              <div>
                ...
                <select name="severity" className="mt-1 w-full rounded-xl border bg-background px-3 py-2 text-sm">
